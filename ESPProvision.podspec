Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/telldus/esp-idf-provisioning-ios"
  ...
  spec.source = { :git => "https://github.com/telldus/esp-idf-provisioning-ios.git", :tag => "lib-#{spec.version}" }
